...
if __name__=="__main__":
    ...
    accuracy_file = []
    accuracy_file.append('./Results/FedRS_{}_rounds/FedRS_niid_{}/FedRS_Global_accuracy_niid_{}.csv'.format(rnd, iidness, iidness))
    os.makedirs(os.path.dirname(accuracy_file[0]), exist_ok=True)
    for i in range(10):
        accuracy_file.append('./Results/FedRS_{}_rounds/FedRS_niid_{}/FedRS_Client_{}_accuracy_niid_{}.csv'.format(rnd, iidness, i+1, iidness))
